...
::construct_from(MatrixType& matrix, cusp::hyb_format)
{
    ...
    {
        // This used to be commented out for some reason.
        // If this function behaves funny in the future, this might be the issue.
        // But uncommenting it fixes our current issues where the view is not constructed correctly.
